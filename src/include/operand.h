...
static inline double _divide(double a, double b) { return a / b; }
...
static inline uint64_t _idivide(uint64_t a, uint64_t b) { return a / b; }
...
static inline double _root(double a, double b) { return pow(a, 1 / b); }
